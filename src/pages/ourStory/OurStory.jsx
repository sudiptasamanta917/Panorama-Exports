            ...
            <section className="bg-white">
                ...
                <div className="relative bg-[#b9a686]">
                    <div className="w-[90%] mx-auto py-16 px-6 md:px-20 grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="relative z-10 bg-white p-8 shadow-lg rounded-lg h-[400px]">
                            <p className="text-gray-700 leading-relaxed">
                                Innovation is our language—spoken through
                                designs that inspire and lead globally. We don't
                                just follow trends—we anticipate them, crafting
                                future-ready fashion with purpose. Every
                                creation is a translation of insight,
                    ...
                    <div className="w-[90%] mx-auto pb-16 px-6 md:px-20 grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="relative z-10 bg-white p-8 shadow-lg rounded-lg h-[400px]">
                            <p className="text-gray-700 leading-relaxed">
                                Our identity is crafted through integrity and
                                defined by an unwavering commitment to
                                brilliance & values that shape every garment,
                                every partnership, and every milestone on our
                                global journey.
                            </p>
                            <h2 className="text-xl font-bold mb-4">
                                Navin Sahni
