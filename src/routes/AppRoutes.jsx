...
export default function AppRoutes() {
    return (
        <Routes>
            ...
            <Route path="/ourstory/rootsofexcellence" element={<RootOfExcellence />} />
            ...
            <Route path="/craftedprecision/manufacturingexcellence" element={<MfgExcellence />} />
            <Route path="/craftedprecision/smartwarehousing" element={<SmartWarehousing />} />
            <Route path="/craftedprecision/artthread" element={<ArtInEveryThread />} />
            <Route path="/craftedprecision/exactingstandards" element={<ExactingStandards />} />
            <Route path="/craftedprecision/sustainabledesigns" element={<SustainableDesigns />} />
            <Route path="/craftedprecision/advancedwashing" element={<AdvancedWashing />} />
            <Route path="/craftedprecision/adaptivecapacity" element={<AdaptiveCapacity />} />
            <Route path="/innovation/innovationleads" element={<InnovationThatLeads/>} />
            <Route path="/innovation/standardperfection" element={<StandardOfPerfection/>} />
            <Route path="/innovation/handcraftedluxury" element={<HandcraftedLuxury/>} />
            <Route path="/products" element={<Products/>} />
            <Route path="/peoples" element={<Peoples/>} />
            <Route path="/responsibilityroute" element={<ResponsibilityRoute/>} />
        </Routes>
    );
}
